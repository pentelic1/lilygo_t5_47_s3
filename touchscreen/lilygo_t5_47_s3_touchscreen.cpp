#include "lilygo_t5_47_s3_touchscreen.h"

#include "esphome/core/helpers.h"
#include "esphome/core/log.h"

namespace esphome {
namespace lilygo_t5_47_s3 {

static const char *const TAG = "lilygo_t5_47_s3.touchscreen";

static const uint8_t POWER_REGISTER = 0xD6;
static const uint8_t TOUCH_REGISTER = 0x09;  //changed from 0xD0 (13) from original
...
void LilygoT547s3Touchscreen::setup() {
  ESP_LOGCONFIG(TAG, "Setting up Lilygo T5 4.7 S3 Touchscreen...");
...
void LilygoT547s3Touchscreen::loop() {
...
void LilygoT547s3Touchscreen::dump_config() {
  ESP_LOGCONFIG(TAG, "Lilygo T5 47 S3 Touchscreen:");
  LOG_I2C_DEVICE(this);
